...
public class RenderLiving extends Render {
	...
	public void doRenderLiving(EntityLiving var1, double var2, double var4, double var6, float var8, float var9) {
		...
		try {
			float var10 = var1.renderYawOffset + (var1.field_9363_r - var1.renderYawOffset) * var9;
			float var11 = var1.rotationPitch + (var1.aR - var1.rotationPitch) * var9;
			...
			float var15 = var1.field_9325_U + (var1.field_705_Q - var1.field_9325_U) * var9;
			float var16 = var1.field_704_R - var1.field_705_Q * (1.0F - var9);
			if(var15 > 1.0F) {
				var15 = 1.0F;
			}

			this.loadDownloadableImageTexture(var1.bz, var1.getEntityTexture());
			...
			if((var18 >> 24 & 255) > 0 || var1.prevHealth > 0 || var1.ac > 0) {
				GL11.glDisable(GL11.GL_TEXTURE_2D);
				GL11.glDisable(GL11.GL_ALPHA_TEST);
				GL11.glEnable(GL11.GL_BLEND);
				GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
				GL11.glDepthFunc(GL11.GL_EQUAL);
				if(var1.prevHealth > 0 || var1.ac > 0) {
	...
	protected void rotateCorpse(EntityLiving var1, float var2, float var3, float var4) {
		...
		if(var1.ac > 0) {
			float var5 = ((float)var1.ac + var4 - 1.0F) / 20.0F * 1.6F;
	...
	protected void passSpecialRender(EntityLiving var1, double var2, double var4, double var6) {
		if(Minecraft.isDebugInfoEnabled()) {
			this.renderLivingLabel(var1, Integer.toString(var1.aC), var2, var4, var6, 64);
		}
