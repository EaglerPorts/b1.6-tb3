...
public class EntityPainting extends Entity {
	...
	public EntityPainting(World var1, int var2, int var3, int var4, int var5) {
		...
		if(var6.size() > 0) {
			this.art = (EnumArt)var6.get(this.br.nextInt(var6.size()));
		}
	...
	public void func_412_b(int var1) {
		this.direction = var1;
		this.rotationPitch = this.aR = (float)(var1 * 90);
		...
		this.aV.setBounds((double)(var5 - var2 - var9), (double)(var6 - var3 - var9), (double)(var7 - var4 - var9), (double)(var5 + var2 + var9), (double)(var6 + var3 + var9), (double)(var7 + var4 + var9));
	}
	...
	public void onUpdate() {
		if(this.field_695_c++ == 100 && !this.aH.multiplayerWorld) {
			this.field_695_c = 0;
			if(!this.func_410_i()) {
				this.setEntityDead();
				this.aH.entityJoinedWorld(new EntityItem(this.aH, this.prevPosZ, this.posX, this.posY, new ItemStack(Item.painting)));
			}
		}
	...
	public boolean func_410_i() {
		if(this.aH.getCollidingBoundingBoxes(this, this.aV).size() > 0) {
			...
			if(this.direction == 0) {
				var3 = MathHelper.floor_double(this.prevPosZ - (double)((float)this.art.sizeX / 32.0F));
			}

			if(this.direction == 1) {
				var5 = MathHelper.floor_double(this.posY - (double)((float)this.art.sizeX / 32.0F));
			}
			...
			var4 = MathHelper.floor_double(this.posX - (double)((float)this.art.sizeY / 32.0F));
			...
			for(int var6 = 0; var6 < var1; ++var6) {
				for(var7 = 0; var7 < var2; ++var7) {
					...
					if(this.direction != 0 && this.direction != 2) {
						var8 = this.aH.getBlockMaterial(this.xPosition, var4 + var7, var5 + var6);
					} else {
						var8 = this.aH.getBlockMaterial(var3 + var6, var4 + var7, this.zPosition);
					}
			...
			List var9 = this.aH.getEntitiesWithinAABBExcludingEntity(this, this.aV);
	...
	public boolean attackEntityFrom(Entity var1, int var2) {
		if(!this.field_9293_aM && !this.aH.multiplayerWorld) {
			this.setEntityDead();
