...
public class EntityPortalFX extends EntityFX {
	...
	public EntityPortalFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
		...
		this.motionX = var10;
		this.motionY = var12;
		this.field_4086_p = this.prevPosZ = var2;
		this.field_4085_q = this.posX = var4;
		this.field_4084_r = this.posY = var6;
		float var14 = this.br.nextFloat() * 0.6F + 0.4F;
		this.field_4083_a = this.particleScale = this.br.nextFloat() * 0.2F + 0.5F;
	...
	public void onUpdate() {
		...
		var1 = 1.0F - var1;
		this.prevPosZ = this.field_4086_p + this.posZ * (double)var1;
		this.posX = this.field_4085_q + this.motionX * (double)var1 + (double)(1.0F - var2);
		this.posY = this.field_4084_r + this.motionY * (double)var1;
