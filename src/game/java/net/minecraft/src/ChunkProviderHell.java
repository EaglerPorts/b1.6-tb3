...
public class ChunkProviderHell implements IChunkProvider {
	...
	public void func_4058_b(int var1, int var2, byte[] var3) {
		...
		this.field_4162_p = this.field_4166_l.generateNoiseOctaves(this.field_4162_p, (double) (var1 * 16),
				(double) (var2 * 16), 0.0D, 16, 16, 1, var5, var5, 1.0D);
		this.field_4161_q = this.field_4166_l.generateNoiseOctaves(this.field_4161_q, (double) (var1 * 16), 109.0134D,
				(double) (var2 * 16), 16, 1, 16, var5, 1.0D, var5);
		this.field_4160_r = this.field_4165_m.generateNoiseOctaves(this.field_4160_r, (double) (var1 * 16),
	...
	private double[] func_4057_a(double[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		...
		this.field_4172_f = this.field_4177_a.generateNoiseOctaves(this.field_4172_f, (double) var2, (double) var3,
				(double) var4, var5, 1, var7, 1.0D, 0.0D, 1.0D);
		this.field_4171_g = this.field_4176_b.generateNoiseOctaves(this.field_4171_g, (double) var2, (double) var3,
				(double) var4, var5, 1, var7, 100.0D, 0.0D, 100.0D);
		this.field_4175_c = this.field_4167_k.generateNoiseOctaves(this.field_4175_c, (double) var2, (double) var3,
				(double) var4, var5, var6, var7, var8 / 80.0D, var10 / 60.0D, var8 / 80.0D);
		this.field_4174_d = this.field_4169_i.generateNoiseOctaves(this.field_4174_d, (double) var2, (double) var3,
				(double) var4, var5, var6, var7, var8, var10, var8);
		this.field_4173_e = this.field_4168_j.generateNoiseOctaves(this.field_4173_e, (double) var2, (double) var3,
				(double) var4, var5, var6, var7, var8, var10, var8);
		int var12 = 0;
		int var13 = 0;
