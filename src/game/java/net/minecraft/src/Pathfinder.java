...
public class Pathfinder {
	...
	public PathEntity createEntityPathTo(Entity var1, Entity var2, float var3) {
		return this.createEntityPathTo(var1, var2.prevPosZ, var2.aV.minY, var2.posY, var3);
	}
	...
	private PathEntity createEntityPathTo(Entity var1, double var2, double var4, double var6, float var8) {
		...
		PathPoint var9 = this.openPoint(MathHelper.floor_double(var1.aV.minX), MathHelper.floor_double(var1.aV.minY), MathHelper.floor_double(var1.aV.minZ));
