...
public class ItemBoat extends Item {
	...
	public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3) {
		float var4 = 1.0F;
		float var5 = var3.prevRotationYaw + (var3.rotationYaw - var3.prevRotationYaw) * var4;
		float var6 = var3.rotationPitch + (var3.aR - var3.rotationPitch) * var4;
		double var7 = var3.aI + (var3.prevPosZ - var3.aI) * (double)var4;
		double var9 = var3.prevPosX + (var3.posX - var3.prevPosX) * (double)var4 + 1.62D - (double)var3.be;
		double var11 = var3.prevPosY + (var3.posY - var3.prevPosY) * (double)var4;
