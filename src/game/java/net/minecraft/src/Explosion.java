...
public class Explosion {
	...
	public void doExplosionA() {
		...
		List var9 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this.exploder, AxisAlignedBB.getBoundingBoxFromPool(
		...
		for (int var11 = 0; var11 < var9.size(); ++var11) {
			...
			if (var13 <= 1.0D) {
				var15 = var33.prevPosZ - this.explosionX;
				var17 = var33.posX - this.explosionY;
				var19 = var33.posY - this.explosionZ;
				double var39 = (double) MathHelper.sqrt_double(var15 * var15 + var17 * var17 + var19 * var19);
				var15 /= var39;
				var17 /= var39;
				var19 /= var39;
				double var40 = (double) this.worldObj.func_675_a(var31, var33.aV);
				double var41 = (1.0D - var13) * var40;
				var33.attackEntityFrom(this.exploder,
						(int) ((var41 * var41 + var41) / 2.0D * 8.0D * (double) this.explosionSize + 1.0D));
				var33.posZ += var15 * var41;
				var33.motionX += var17 * var41;
				var33.motionY += var19 * var41;
			}
		}
	...
	public void doExplosionB(boolean var1) {
		...
		for (int var3 = var2.size() - 1; var3 >= 0; --var3) {
			...
			if (var1) {
				...
				var17 *= var23;
				var19 *= var23;
				this.worldObj.spawnParticle("explode", (var9 + this.explosionX * 1.0D) / 2.0D,
						(var11 + this.explosionY * 1.0D) / 2.0D, (var13 + this.explosionZ * 1.0D) / 2.0D, var15, var17, var19);
				this.worldObj.spawnParticle("smoke", var9, var11, var13, var15, var17, var19);
			}

			if (var8 > 0) {
				Block.blocksList[var8].dropBlockAsItemWithChance(this.worldObj, var5, var6, var7,
						this.worldObj.getBlockMetadata(var5, var6, var7), 0.3F);
