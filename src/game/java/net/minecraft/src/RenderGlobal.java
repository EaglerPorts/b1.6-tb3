...
public class RenderGlobal implements IWorldAccess {
	...
	public void loadRenderers() {
		...
		if(this.worldObj != null) {
			...
			if(var7 != null) {
				this.markRenderersForNewPosition(MathHelper.floor_double(var7.prevPosZ), MathHelper.floor_double(var7.posX), MathHelper.floor_double(var7.posY));
	...
	public void renderEntities(Vec3D var1, ICamera var2, float var3) {
		if(this.renderEntitiesStartupCounter > 0) {
			...
			for(var6 = 0; var6 < var5.size(); ++var6) {
				...
				if(var7.isInRangeToRenderVec3D(var1) && (var7.bK || var2.isBoundingBoxInFrustum(var7.aV)) && (var7 != this.mc.renderViewEntity || this.mc.gameSettings.thirdPersonView || this.mc.renderViewEntity.isPlayerSleeping())) {
					...
					if(this.worldObj.blockExists(MathHelper.floor_double(var7.prevPosZ), var8, MathHelper.floor_double(var7.posY))) {
						++this.countEntitiesRendered;
						RenderManager.instance.renderEntity(var7, var3);
					}
				}
	...
	public int sortAndRender(EntityLiving var1, int var2, double var3) {
		...
		if(var11 * var11 + var13 * var13 + var15 * var15 > 16.0D) {
			...
			this.markRenderersForNewPosition(MathHelper.floor_double(var1.prevPosZ), MathHelper.floor_double(var1.posX), MathHelper.floor_double(var1.posY));
	...
	public void renderClouds(float var1) {
		if(!this.mc.theWorld.worldProvider.isNether) {
			if(this.mc.gameSettings.fancyGraphics) {
				...
				float var2 = (float)(this.mc.renderViewEntity.lastTickPosX + (this.mc.renderViewEntity.posX - this.mc.renderViewEntity.lastTickPosX) * (double)var1);
				byte var3 = 32;
				int var4 = 256 / var3;
				...
				var10 = 0.5F / 1024.0F;
				double var22 = this.mc.renderViewEntity.aI + (this.mc.renderViewEntity.prevPosZ - this.mc.renderViewEntity.aI) * (double)var1 + (double)(((float)this.cloudOffsetX + var1) * 0.03F);
				double var13 = this.mc.renderViewEntity.prevPosY + (this.mc.renderViewEntity.posY - this.mc.renderViewEntity.prevPosY) * (double)var1;
	...
	public void renderCloudsFancy(float var1) {
		...
		float var4 = 12.0F;
		float var5 = 4.0F;
		double var6 = (this.mc.renderViewEntity.aI + (this.mc.renderViewEntity.prevPosZ - this.mc.renderViewEntity.aI) * (double)var1 + (double)(((float)this.cloudOffsetX + var1) * 0.03F)) / (double)var4;
		double var8 = (this.mc.renderViewEntity.prevPosY + (this.mc.renderViewEntity.posY - this.mc.renderViewEntity.prevPosY) * (double)var1) / (double)var4 + (double)0.33F;
