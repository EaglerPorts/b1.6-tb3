...
public class Chunk {
	...
	public void generateHeightMap() {
		...
		for (int var2 = 0; var2 < 16; ++var2) {
			for (int var3 = 0; var3 < 16; ++var3) {
				...
				for (int var5 = var2 << 11 | var3 << 7; var4 > 0
						&& Block.lightOpacity[this.blocks[var5 + var4 - 1] & 255] == 0; --var4) {
				}
	...
	public void func_1024_c() {
		...
		for (var2 = 0; var2 < 16; ++var2) {
			for (var3 = 0; var3 < 16; ++var3) {
				...
				int var5;
				for (var5 = var2 << 11 | var3 << 7; var4 > 0
						&& Block.lightOpacity[this.blocks[var5 + var4 - 1] & 255] == 0; --var4) {
				}
	...
	private void func_1003_g(int var1, int var2, int var3) {
		...
		for (int var6 = var1 << 11 | var3 << 7; var5 > 0
				&& Block.lightOpacity[this.blocks[var6 + var5 - 1] & 255] == 0; --var5) {
		}
	...
	public int getSavedLightValue(EnumSkyBlock var1, int var2, int var3, int var4) {
		return var1 == EnumSkyBlock.Sky ? this.skylightMap.getNibble(var2, var3, var4)
				: (var1 == EnumSkyBlock.Block ? this.blocklightMap.getNibble(var2, var3, var4) : 0);
	}
	...
	public void addEntity(Entity var1) {
		...
		int var4 = MathHelper.floor_double(var1.posX / 16.0D);
		if (var4 < 0) {
			var4 = 0;
		}
		...
		var1.bD = true;
		var1.bE = this.xPosition;
		var1.chunkCoordX = var4;
		var1.chunkCoordY = this.zPosition;
		this.entities[var4].add(var1);
	}

	public void removeEntity(Entity var1) {
		this.removeEntityAtIndex(var1, var1.chunkCoordX);
	}
	...
	public void setChunkBlockTileEntity(int var1, int var2, int var3, TileEntity var4) {
		...
		if (this.getBlockID(var1, var2, var3) != 0
				&& Block.blocksList[this.getBlockID(var1, var2, var3)] instanceof BlockContainer) {
	...
	public void getEntitiesWithinAABBForEntity(Entity var1, AxisAlignedBB var2, List var3) {
		...
		for (int var6 = var4; var6 <= var5; ++var6) {
			...
			for (int var8 = 0; var8 < var7.size(); ++var8) {
				...
				if (var9 != var1 && var9.aV.intersectsWith(var2)) {
					var3.add(var9);
				}
			}
		}
	...
	public void getEntitiesOfTypeWithinAAAB(Class var1, AxisAlignedBB var2, List var3) {
		...
		for (int var6 = var4; var6 <= var5; ++var6) {
			...
			for (int var8 = 0; var8 < var7.size(); ++var8) {
				Entity var9 = (Entity) var7.get(var8);
				if (var1.isAssignableFrom(var9.getClass()) && var9.aV.intersectsWith(var2)) {
					var3.add(var9);
				}
			}
		}
