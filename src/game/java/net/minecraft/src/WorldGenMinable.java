...
public class WorldGenMinable extends WorldGenerator {
	...
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		...
		for (int var19 = 0; var19 <= this.numberOfBlocks; ++var19) {
			...
			double var28 = (double) (MathHelper.sin((float) var19 * (float) Math.PI / (float) this.numberOfBlocks) + 1.0F)
					* var26 + 1.0D;
			double var30 = (double) (MathHelper.sin((float) var19 * (float) Math.PI / (float) this.numberOfBlocks) + 1.0F)
					* var26 + 1.0D;
						...
						if (var39 * var39 + var42 * var42 < 1.0D) {
							for (int var44 = var34; var44 <= var37; ++var44) {
								...
								if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D
										&& var1.getBlockId(var38, var41, var44) == Block.stone.blockID) {
