...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
		...
		if (this.mc.gameSettings.showDebugInfo) {
			...
			var23 = "Used memory: " + var21 * 100L / var24 + "% (" + var21 / 1024L / 1024L + "MB) of " + var24 / 1024L / 1024L
					+ "MB";
			...
			if (this.mc.gameSettings.showFramerate)
				var8.drawStringWithShadow("Minecraft Beta 1.6 Test Build 3 (" + this.mc.fps + " fps)", 2, 2, 16777215);
			else
				var8.drawStringWithShadow("Minecraft Beta 1.6 Test Build 3", 2, 2, 16777215);
			if (this.mc.gameSettings.showCoords)
				var8.drawStringWithShadow("x: " + (int) Math.floor(this.mc.thePlayer.prevPosZ) + ", y: "
						+ (int) Math.floor(this.mc.thePlayer.posX) + ", z: " + (int) Math.floor(this.mc.thePlayer.posY), 2, 12,
						16777215);
		}
