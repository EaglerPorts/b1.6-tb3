...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
		...
		float var10 = this.mc.thePlayer.timeInPortal + (this.mc.thePlayer.A - this.mc.thePlayer.timeInPortal) * var1;
		if(var10 > 0.0F) {
		...
		boolean var12 = this.mc.thePlayer.bx / 3 % 2 == 1;
		if(this.mc.thePlayer.bx < 10) {
			var12 = false;
		}

		int var13 = this.mc.thePlayer.X;
		int var14 = this.mc.thePlayer.health;
		...
		if(this.mc.playerController.shouldDrawHUD()) {
			...
			if(this.mc.thePlayer.isInsideOfMaterial(Material.water)) {
				var16 = (int)Math.ceil((double)(this.mc.thePlayer.field_9306_bj - 2) * 10.0D / 300.0D);
				var17 = (int)Math.ceil((double)this.mc.thePlayer.field_9306_bj * 10.0D / 300.0D) - var16;
		...
		if(this.mc.gameSettings.showDebugInfo) {
			var8.drawStringWithShadow("Minecraft Beta 1.6 Test Build 3 (" + this.mc.debug + ")", 2, 2, 16777215);
			...
			this.drawString(var8, "x: " + this.mc.thePlayer.prevPosZ, 2, 64, 14737632);
			this.drawString(var8, "y: " + this.mc.thePlayer.posX, 2, 72, 14737632);
			this.drawString(var8, "z: " + this.mc.thePlayer.posY, 2, 80, 14737632);
		} else {
			if (this.mc.gameSettings.showFramerate) var8.drawStringWithShadow("Minecraft Beta 1.6 Test Build 3 (" + this.mc.fps + " fps)", 2, 2, 16777215);
			else var8.drawStringWithShadow("Minecraft Beta 1.6 Test Build 3", 2, 2, 16777215);
			if (this.mc.gameSettings.showCoords) var8.drawStringWithShadow("x: " + (int) Math.floor(this.mc.thePlayer.prevPosZ) + ", y: " + (int) Math.floor(this.mc.thePlayer.posX) + ", z: " + (int) Math.floor(this.mc.thePlayer.posY), 2, 12, 16777215);
		}
