...
public class ItemMap extends ItemMapBase {
	...
	public void func_28011_a(World var1, Entity var2, MapData var3) {
		if(var1.worldProvider.worldType == var3.field_28178_d) {
			...
			int var9 = MathHelper.floor_double(var2.prevPosZ - (double)var7) / var6 + var4 / 2;
			int var10 = MathHelper.floor_double(var2.posY - (double)var8) / var6 + var5 / 2;
			int var11 = 128 / var6;
	...
	public void onCreated(ItemStack var1, World var2, EntityPlayer var3) {
		...
		var5.field_28180_b = MathHelper.floor_double(var3.prevPosZ);
		var5.field_28179_c = MathHelper.floor_double(var3.posY);
