...
public class RenderManager {
	...
	public void cacheActiveRenderInfo(World var1, RenderEngine var2, FontRenderer var3, EntityLiving var4, GameSettings var5, float var6) {
		...
		this.playerViewY = var4.rotationPitch + (var4.aR - var4.rotationPitch) * var6;
		this.playerViewX = var4.prevRotationYaw + (var4.rotationYaw - var4.prevRotationYaw) * var6;
		this.field_1222_l = var4.bk + (var4.prevPosZ - var4.bk) * (double)var6;
		this.field_1221_m = var4.lastTickPosX + (var4.posX - var4.lastTickPosX) * (double)var6;
		this.field_1220_n = var4.lastTickPosY + (var4.posY - var4.lastTickPosY) * (double)var6;
	}

	public void renderEntity(Entity var1, float var2) {
		double var3 = var1.bk + (var1.prevPosZ - var1.bk) * (double)var2;
		double var5 = var1.lastTickPosX + (var1.posX - var1.lastTickPosX) * (double)var2;
		double var7 = var1.lastTickPosY + (var1.posY - var1.lastTickPosY) * (double)var2;
		float var9 = var1.rotationPitch + (var1.aR - var1.rotationPitch) * var2;
