...
public class EntityFootStepFX extends EntityFX {
	...
	public void renderParticle(Tessellator var1, float var2, float var3, float var4, float var5, float var6, float var7) {
		...
		float var11 = (float)(this.prevPosZ - interpPosX);
		float var12 = (float)(this.posX - interpPosY);
		float var13 = (float)(this.posY - interpPosZ);
		float var14 = this.aH.getLightBrightness(MathHelper.floor_double(this.prevPosZ), MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY));
