...
class GuiTexturePackSlot extends GuiSlot {
	...
	protected void drawSlot(int var1, int var2, int var3, int var4, Tessellator var5) {
		...
		var5.draw();
		this.parentTexturePackGui.drawString(GuiTexturePacks.func_22127_j(this.parentTexturePackGui), var6.getName(), var2 + 32 + 2, var3 + 1, 16777215);
		String[] desc = var6.getDescription();
		this.parentTexturePackGui.drawString(GuiTexturePacks.func_22120_k(this.parentTexturePackGui), desc[0], var2 + 32 + 2, var3 + 12, 8421504);
		this.parentTexturePackGui.drawString(GuiTexturePacks.func_22125_l(this.parentTexturePackGui), desc[1], var2 + 32 + 2, var3 + 12 + 10, 8421504);
	}
}
