...
public class GuiInventory extends GuiContainer {
	...
	protected void drawGuiContainerBackgroundLayer(float var1) {
		...
		float var6 = this.mc.thePlayer.field_9363_r;
		float var7 = this.mc.thePlayer.aR;
		float var8 = this.mc.thePlayer.rotationYaw;
		...
		this.mc.thePlayer.field_9363_r = (float)Math.atan((double)(var9 / 40.0F)) * 20.0F;
		this.mc.thePlayer.aR = (float)Math.atan((double)(var9 / 40.0F)) * 40.0F;
		this.mc.thePlayer.rotationYaw = -((float)Math.atan((double)(var10 / 40.0F))) * 20.0F;
		GL11.glTranslatef(0.0F, this.mc.thePlayer.be, 0.0F);
		RenderManager.instance.playerViewY = 180.0F;
		RenderManager.instance.renderEntityWithPosYaw(this.mc.thePlayer, 0.0D, 0.0D, 0.0D, 0.0F, 1.0F);
		this.mc.thePlayer.field_9363_r = var6;
		this.mc.thePlayer.aR = var7;
		this.mc.thePlayer.rotationYaw = var8;
		GL11.glPopMatrix();
