...
public class GuiVideoSettings extends GuiScreen {
	...
	private static EnumOptions[] field_22108_k = new EnumOptions[]{EnumOptions.GRAPHICS, EnumOptions.RENDER_DISTANCE, EnumOptions.ANAGLYPH, EnumOptions.VIEW_BOBBING, EnumOptions.AMBIENT_OCCLUSION, EnumOptions.VSYNC, EnumOptions.FANCY_GRASS, EnumOptions.GUI_SCALE};
