...
public class RenderFallingSand extends Render {
	...
	public void func_156_a(EntityFallingSand var1, double var2, double var4, double var6, float var8, float var9) {
		...
		this.field_197_d.renderBlockFallingSand(var10, var11, MathHelper.floor_double(var1.prevPosZ), MathHelper.floor_double(var1.posX), MathHelper.floor_double(var1.posY));
