...
public class Teleporter {
	...
	public boolean func_4106_b(World var1, Entity var2) {
		...
		int var7 = 0;
		int var8 = 0;
		int var9 = MathHelper.floor_double(var2.prevPosZ);
		int var10 = MathHelper.floor_double(var2.posY);

		double var18;
		for (int var11 = var9 - var3; var11 <= var9 + var3; ++var11) {
			double var12 = (double) var11 + 0.5D - var2.prevPosZ;

			for (int var14 = var10 - var3; var14 <= var10 + var3; ++var14) {
				double var15 = (double) var14 + 0.5D - var2.posY;
				...
				for (int var17 = 127; var17 >= 0; --var17) {
					if (var1.getBlockId(var11, var17, var14) == Block.portal.blockID) {
						...
						var18 = (double) var17 + 0.5D - var2.posX;
		...
		if (var4 >= 0.0D) {
			...
			var2.setLocationAndAngles(var22, var16, var18, var2.aR, 0.0F);
	...
	public boolean func_4108_c(World var1, Entity var2) {
		byte var3 = 16;
		double var4 = -1.0D;
		int var6 = MathHelper.floor_double(var2.prevPosZ);
		int var7 = MathHelper.floor_double(var2.posX);
		int var8 = MathHelper.floor_double(var2.posY);
		int var9 = var6;
		int var10 = var7;
		int var11 = var8;
		int var12 = 0;
				...
				label293: for (var20 = 127; var20 >= 0; --var20) {
					if (var1.isAirBlock(var14, var20, var17)) {
						...
						for (var21 = var13; var21 < var13 + 4; ++var21) {
							...
							var32 = (double) var20 + 0.5D - var2.posX;
		...
		if (var4 < 0.0D) {
			for (var14 = var6 - var3; var14 <= var6 + var3; ++var14) {
				...
				for (var17 = var8 - var3; var17 <= var8 + var3; ++var17) {
					...
					label231: for (var20 = 127; var20 >= 0; --var20) {
						if (var1.isAirBlock(var14, var20, var17)) {
