...
public final class SpawnerAnimals {
	...
	public static final int performSpawning(World var0, boolean var1, boolean var2) {
		if(!var1 && !var2) {
			...
			for(var3 = 0; var3 < var0.playerEntities.size(); ++var3) {
				...
				int var5 = MathHelper.floor_double(var4.prevPosZ / 16.0D);
				var6 = MathHelper.floor_double(var4.posY / 16.0D);
				byte var7 = 8;
								...
								if(canCreatureTypeSpawnAtLocation(var38, var0, var22, var23, var24)) {
									...
									if(var0.getClosestPlayer((double)var27, (double)var28, (double)var29, 24.0D) == null) {
										...
										if(var33 >= 576.0F) {
											EntityLiving var43;
											try {
												var43 = (EntityLiving)var15.entityClass.createEntity(var0);
	...
	private static void creatureSpecificInit(EntityLiving var0, World var1, float var2, float var3, float var4) {
		if(var0 instanceof EntitySpider && var1.rand.nextInt(100) == 0) {
			...
			var5.setLocationAndAngles((double)var2, (double)var3, (double)var4, var0.aR, 0.0F);
	...
	public static boolean performSleepSpawning(World var0, List var1) {
		...
		while(true) {
			...
			for(int var8 = 0; var8 < 20 && !var7; ++var8) {
				int var9 = MathHelper.floor_double(var5.prevPosZ) + var0.rand.nextInt(32) - var0.rand.nextInt(32);
				int var10 = MathHelper.floor_double(var5.posY) + var0.rand.nextInt(32) - var0.rand.nextInt(32);
				int var11 = MathHelper.floor_double(var5.posX) + var0.rand.nextInt(16) - var0.rand.nextInt(16);
				if(var11 < 1) {
					var11 = 1;
				} else if(var11 > 128) {
					var11 = 128;
				...
				if(var13 < var11 + 16 && var13 < 128) {
					...
					if(var17.getCanSpawnHere()) {
						...
						if(var18 != null && var18.pathLength > 1) {
							...
							if(Math.abs((double)var19.xCoord - var5.prevPosZ) < 1.5D && Math.abs((double)var19.zCoord - var5.posY) < 1.5D && Math.abs((double)var19.yCoord - var5.posX) < 1.5D) {
								ChunkCoordinates var20 = BlockBed.getNearestEmptyChunkCoordinates(var0, MathHelper.floor_double(var5.prevPosZ), MathHelper.floor_double(var5.posX), MathHelper.floor_double(var5.posY), 1);
								if(var20 == null) {
