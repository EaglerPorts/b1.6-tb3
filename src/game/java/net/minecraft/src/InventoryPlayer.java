...
public class InventoryPlayer implements IInventory {
	...
	public void decrementAnimations() {
		for(int var1 = 0; var1 < this.mainInventory.length; ++var1) {
			if(this.mainInventory[var1] != null) {
				this.mainInventory[var1].updateAnimation(this.player.aH, this.player, var1, this.currentItem == var1);
			}
		}
	...
	public boolean canInteractWith(EntityPlayer var1) {
		return this.player.field_9293_aM ? false : var1.getDistanceSqToEntity(this.player) <= 64.0D;
	}

	public boolean func_28018_c(ItemStack var1) {
		int var2;
		for(var2 = 0; var2 < this.armorInventory.length; ++var2) {
			if(this.armorInventory[var2] != null && this.armorInventory[var2].b(var1)) {
				return true;
			}
		}

		for(var2 = 0; var2 < this.mainInventory.length; ++var2) {
			if(this.mainInventory[var2] != null && this.mainInventory[var2].b(var1)) {
				return true;
			}
		}
