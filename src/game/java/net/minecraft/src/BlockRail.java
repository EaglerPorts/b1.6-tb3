...
public class BlockRail extends Block {
	...
	public void onNeighborBlockChange(World var1, int var2, int var3, int var4, int var5) {
		if (!var1.multiplayerWorld) {
			...
			if (var8) {
				...
				var9 = var9 || this.func_27044_a(var1, var2, var3, var4, var6, true, 0)
						|| this.func_27044_a(var1, var2, var3, var4, var6, false, 0);
				boolean var10 = false;
				if (var9 && (var6 & 8) == 0) {
			...
			} else if (var5 > 0 && Block.blocksList[var5].canProvidePower() && !this.isPowered
					&& RailLogic.getNAdjacentTracks(new RailLogic(this, var1, var2, var3, var4)) == 3) {
	...
	private boolean func_27044_a(World var1, int var2, int var3, int var4, int var5, boolean var6, int var7) {
		if (var7 >= 8) {
			...
			return this.func_27043_a(var1, var2, var3, var4, var6, var7, var8) ? true
					: var9 && this.func_27043_a(var1, var2, var3 - 1, var4, var6, var7, var8);
		}
	}
