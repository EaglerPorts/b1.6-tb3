...
public class RenderPainting extends Render {
	...
	private void func_160_a(EntityPainting var1, float var2, float var3) {
		...
		int var5 = MathHelper.floor_double(var1.posX + (double)(var3 / 16.0F));
		int var6 = MathHelper.floor_double(var1.posY);
		if(var1.direction == 0) {
			var4 = MathHelper.floor_double(var1.prevPosZ + (double)(var2 / 16.0F));
		}

		if(var1.direction == 1) {
			var6 = MathHelper.floor_double(var1.posY - (double)(var2 / 16.0F));
		}
