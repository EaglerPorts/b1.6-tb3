...
public class EntityLightningBolt extends EntityWeatherEffect {
	...
	public EntityLightningBolt(World var1, double var2, double var4, double var6) {
		...
		this.field_27029_a = this.br.nextLong();
		this.field_27030_c = this.br.nextInt(3) + 1;
		if(var1.difficultySetting >= 2 && var1.doChunksNearChunkExist(MathHelper.floor_double(var2), MathHelper.floor_double(var4), MathHelper.floor_double(var6), 10)) {
			...
			for(var8 = 0; var8 < 4; ++var8) {
				var9 = MathHelper.floor_double(var2) + this.br.nextInt(3) - 1;
				var10 = MathHelper.floor_double(var4) + this.br.nextInt(3) - 1;
				int var11 = MathHelper.floor_double(var6) + this.br.nextInt(3) - 1;
	...
	public void onUpdate() {
		...
		if(this.field_27028_b == 2) {
			this.aH.playSoundEffect(this.prevPosZ, this.posX, this.posY, "ambient.weather.thunder", 10000.0F, 0.8F + this.br.nextFloat() * 0.2F);
			this.aH.playSoundEffect(this.prevPosZ, this.posX, this.posY, "random.explode", 2.0F, 0.5F + this.br.nextFloat() * 0.2F);
		}
		...
		if(this.field_27028_b < 0) {
			if(this.field_27030_c == 0) {
				this.setEntityDead();
			} else if(this.field_27028_b < -this.br.nextInt(10)) {
				--this.field_27030_c;
				this.field_27028_b = 1;
				this.field_27029_a = this.br.nextLong();
				if(this.aH.doChunksNearChunkExist(MathHelper.floor_double(this.prevPosZ), MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), 10)) {
					int var1 = MathHelper.floor_double(this.prevPosZ);
					int var2 = MathHelper.floor_double(this.posX);
					int var3 = MathHelper.floor_double(this.posY);
					if(this.aH.getBlockId(var1, var2, var3) == 0 && Block.fire.canPlaceBlockAt(this.aH, var1, var2, var3)) {
						this.aH.setBlockWithNotify(var1, var2, var3, Block.fire.blockID);
					}
				}
			}
		}
		...
		if(this.field_27028_b >= 0) {
			double var6 = 3.0D;
			List var7 = this.aH.getEntitiesWithinAABBExcludingEntity(this, AxisAlignedBB.getBoundingBoxFromPool(this.prevPosZ - var6, this.posX - var6, this.posY - var6, this.prevPosZ + var6, this.posX + 6.0D + var6, this.posY + var6));
