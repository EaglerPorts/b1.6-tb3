...
public class MapGenCavesHell extends MapGenBase {
	...
	protected void func_4128_a(int var1, int var2, byte[] var3, double var4, double var6, double var8, float var10,
			float var11, float var12, int var13, int var14, double var15) {
		...
		for (boolean var26 = var23.nextInt(6) == 0; var13 < var14; ++var13) {
			...
			if (!var51 && var13 == var25 && var10 > 1.0F) {
				this.func_4128_a(var1, var2, var3, var4, var6, var8, var23.nextFloat() * 0.5F + 0.5F,
						...
						for (int var41 = var54; !var55 && var41 < var38; ++var41) {
							for (int var42 = var36 + 1; !var55 && var42 >= var53 - 1; --var42) {
								...
								if (var42 >= 0 && var42 < 128) {
									...
									if (var42 != var53 - 1 && var40 != var52 && var40 != var34 - 1 && var41 != var54
											&& var41 != var38 - 1) {
										var42 = var53;
									}
								}
							...
							for (var43 = var54; var43 < var38; ++var43) {
								...
								for (int var47 = var36 - 1; var47 >= var53; --var47) {
									...
									if (var48 > -0.7D && var56 * var56 + var48 * var48 + var44 * var44 < 1.0D) {
										...
										if (var50 == Block.netherrack.blockID || var50 == Block.dirt.blockID
												|| var50 == Block.grass.blockID) {
											var3[var46] = 0;
										}
									}
