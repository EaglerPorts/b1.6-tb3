...
public class BlockFire extends Block {
	...
	public void updateTick(World var1, int var2, int var3, int var4, Random var5) {
		...
		if (var6 || !var1.func_27161_C()
				|| !var1.canBlockBeRainedOn(var2, var3, var4) && !var1.canBlockBeRainedOn(var2 - 1, var3, var4)
						&& !var1.canBlockBeRainedOn(var2 + 1, var3, var4) && !var1.canBlockBeRainedOn(var2, var3, var4 - 1)
						&& !var1.canBlockBeRainedOn(var2, var3, var4 + 1)) {
						...
						for (int var10 = var3 - 1; var10 <= var3 + 4; ++var10) {
							if (var8 != var2 || var10 != var3 || var9 != var4) {
								...
								if (var12 > 0) {
									...
									if (var13 > 0 && var5.nextInt(var11) <= var13
											&& (!var1.func_27161_C() || !var1.canBlockBeRainedOn(var8, var10, var9))
											&& !var1.canBlockBeRainedOn(var8 - 1, var10, var4)
											&& !var1.canBlockBeRainedOn(var8 + 1, var10, var9)
											&& !var1.canBlockBeRainedOn(var8, var10, var9 - 1)
											&& !var1.canBlockBeRainedOn(var8, var10, var9 + 1)) {
	...
	public void randomDisplayTick(World var1, int var2, int var3, int var4, Random var5) {
		if (var5.nextInt(24) == 0) {
			var1.playSoundEffect((double) ((float) var2 + 0.5F), (double) ((float) var3 + 0.5F),
					(double) ((float) var4 + 0.5F), "fire.fire", 1.0F + var5.nextFloat(), var5.nextFloat() * 0.7F + 0.3F);
		}
