...
public class TextureCompassFX extends TextureFX {
	...
	public void onTick() {
		...
		if(this.mc.theWorld != null && this.mc.thePlayer != null) {
			...
			double var23 = (double)var21.x - this.mc.thePlayer.prevPosZ;
			double var25 = (double)var21.z - this.mc.thePlayer.posY;
			var20 = (double)(this.mc.thePlayer.aR - 90.0F) * Math.PI / 180.0D - Math.atan2(var25, var23);
