...
public class BiomeGenBase {
	public static final BiomeGenBase rainforest = (new BiomeGenRainforest()).setColor(588342).setBiomeName("Rainforest")
			.func_4124_a(2094168);
	public static final BiomeGenBase swampland = (new BiomeGenSwamp()).setColor(522674).setBiomeName("Swampland")
			.func_4124_a(9154376);
	public static final BiomeGenBase seasonalForest = (new BiomeGenBase()).setColor(10215459)
	...
	public static final BiomeGenBase taiga = (new BiomeGenTaiga()).setColor(3060051).setBiomeName("Taiga").setEnableSnow()
			.func_4124_a(8107825);
	...
	public static final BiomeGenBase iceDesert = (new BiomeGenDesert()).setColor(16772499).setBiomeName("Ice Desert")
			.setEnableSnow().setDisableRain().func_4124_a(12899129);
	public static final BiomeGenBase tundra = (new BiomeGenBase()).setColor(5762041).setBiomeName("Tundra")
			.setEnableSnow().func_4124_a(12899129);
	...
	protected BiomeGenBase() {
		this.spawnableMonsterList.add(new SpawnListEntry(EntitySpider::new, 10));
		this.spawnableMonsterList.add(new SpawnListEntry(EntityZombie::new, 10));
		this.spawnableMonsterList.add(new SpawnListEntry(EntitySkeleton::new, 10));
		this.spawnableMonsterList.add(new SpawnListEntry(EntityCreeper::new, 10));
		this.spawnableMonsterList.add(new SpawnListEntry(EntitySlime::new, 10));
		this.spawnableCreatureList.add(new SpawnListEntry(EntitySheep::new, 12));
		this.spawnableCreatureList.add(new SpawnListEntry(EntityPig::new, 10));
		this.spawnableCreatureList.add(new SpawnListEntry(EntityChicken::new, 10));
		this.spawnableCreatureList.add(new SpawnListEntry(EntityCow::new, 8));
		this.spawnableWaterCreatureList.add(new SpawnListEntry(EntitySquid::new, 10));
	}
	...
	public List getSpawnableList(EnumCreatureType var1) {
		return var1 == EnumCreatureType.monster ? this.spawnableMonsterList
				: (var1 == EnumCreatureType.creature ? this.spawnableCreatureList
						: (var1 == EnumCreatureType.waterCreature ? this.spawnableWaterCreatureList : null));
	}
