...
public class BlockDispenser extends BlockContainer {
	...
	private void dispenseItem(World var1, int var2, int var3, int var4, Random var5) {
		...
		if (var12 == null) {
			...
			if (var12.itemID == Item.arrow.shiftedIndex) {
				...
				var24.posZ = (double) var9 * var20;
				var24.motionX = (double) 0.2F;
				var24.motionY = (double) var10 * var20;
				var24.posZ += var5.nextGaussian() * (double) 0.0075F * 6.0D;
	...
	public void onBlockPlacedBy(World var1, int var2, int var3, int var4, EntityLiving var5) {
		int var6 = MathHelper.floor_double((double) (var5.aR * 4.0F / 360.0F) + 0.5D) & 3;
		if (var6 == 0) {
		...
		for (int var6 = 0; var6 < var5.getSizeInventory(); ++var6) {
			...
			if (var7 != null) {
				...
				while (var7.stackSize > 0) {
					...
					EntityItem var12 = new EntityItem(var1, (double) ((float) var2 + var8), (double) ((float) var3 + var9),
							(double) ((float) var4 + var10), new ItemStack(var7.itemID, var11, var7.getItemDamage()));
					float var13 = 0.05F;
					var12.posZ = (double) ((float) this.field_28035_a.nextGaussian() * var13);
					var12.motionX = (double) ((float) this.field_28035_a.nextGaussian() * var13 + 0.2F);
					var12.motionY = (double) ((float) this.field_28035_a.nextGaussian() * var13);
