...
public class RegionFile {
	...
	public RegionFile(VFile2 var1) {
		...
		try {
			...
			this.field_22219_c = new RandomAccessMemoryFile(var0, (int) var0.length);
			int var2;
			if(this.field_22219_c.getLength() < 4096L) {
			...
			if((this.field_22219_c.getLength() & 4095L) != 0L) {
				for(var2 = 0; (long)var2 < (this.field_22219_c.getLength() & 4095L); ++var2) {
					this.field_22219_c.write(0);
				}
			}

			var2 = (int)this.field_22219_c.getLength() / 4096;
		...
		try {
			...
			if(var6 != 0 && var7 == var8) {
				...
				if(var10 >= var8) {
					...
					this.field_22219_c.seek(this.field_22219_c.getLength());
	...
	public void func_22196_b() throws IOException {
		field_22212_b.setAllBytes(field_22219_c.getByteArray());
	}
}
