...
public class RenderArrow extends Render {
	public void func_154_a(EntityArrow var1, double var2, double var4, double var6, float var8, float var9) {
		if(var1.rotationPitch != 0.0F || var1.prevRotationYaw != 0.0F) {
			this.loadTexture("/item/arrows.png");
			GL11.glPushMatrix();
			GL11.glTranslatef((float)var2, (float)var4, (float)var6);
			GL11.glRotatef(var1.rotationPitch + (var1.aR - var1.rotationPitch) * var9 - 90.0F, 0.0F, 1.0F, 0.0F);
			GL11.glRotatef(var1.prevRotationYaw + (var1.rotationYaw - var1.prevRotationYaw) * var9, 0.0F, 0.0F, 1.0F);
