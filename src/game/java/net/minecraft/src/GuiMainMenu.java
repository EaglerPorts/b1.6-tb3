...
public class GuiMainMenu extends GuiScreen {
	...
	public GuiMainMenu() {
		try {
			...
			BufferedReader var2 = new BufferedReader(new InputStreamReader(TexturePack.getResourceAsStream("/title/splashes.txt"), Charset.forName("UTF-8")));
			String var3 = "";
	...
	public void initGui() {
		...
		if(!EagRuntime.getConfiguration().isEnableGithubButton()) {
			...
			this.controlList.add(new GuiButton(4, this.width / 2 + 2, var4 + 72, 98, 20, I18n.format("menu.github")));
		}
	...
	protected void actionPerformed(GuiButton var1) {
		...
		if(var1.id == 2) {
			if (false) this.mc.displayGuiScreen(new GuiMultiplayer(this));
	...
	public void drawScreen(int var1, int var2, float var3) {
		...
		GL11.glPopMatrix();
		this.drawString(this.fontRenderer, "Minecraft Beta 1.6 Test Build 3", 2, 2, 5263440);
