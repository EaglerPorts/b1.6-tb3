	...
	protected void actionPerformed(GuiButton var1) {
		...
		if (var1.id == 2) {
			if (false)
				...
				this.mc.displayGuiScreen(new GuiScreenInfo(this,
						new TextLine("notAdded", FormattingCodes.COLOR_ERROR, I18n.format("menu.multiplayer")), new TextLine(""),
						new TextLine("willAdd", 0x888888)));
		}
