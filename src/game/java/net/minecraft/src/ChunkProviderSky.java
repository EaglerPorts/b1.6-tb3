...
public class ChunkProviderSky implements IChunkProvider {
	...
	public void func_28072_a(int var1, int var2, byte[] var3, BiomeGenBase[] var4) {
		...
		this.field_28079_r = this.field_28083_n.generateNoiseOctaves(this.field_28079_r, (double) (var1 * 16),
				(double) (var2 * 16), 0.0D, 16, 16, 1, var5, var5, 1.0D);
		this.field_28078_s = this.field_28083_n.generateNoiseOctaves(this.field_28078_s, (double) (var1 * 16), 109.0134D,
				(double) (var2 * 16), 16, 1, 16, var5, 1.0D, var5);
		this.field_28077_t = this.field_28082_o.generateNoiseOctaves(this.field_28077_t, (double) (var1 * 16),
				(double) (var2 * 16), 0.0D, 16, 16, 1, var5 * 2.0D, var5 * 2.0D, var5 * 2.0D);

		for (int var7 = 0; var7 < 16; ++var7) {
			for (int var8 = 0; var8 < 16; ++var8) {
				BiomeGenBase var9 = var4[var7 + var8 * 16];
				int var10 = (int) (this.field_28077_t[var7 + var8 * 16] / 3.0D + 3.0D
						+ this.field_28087_j.nextDouble() * 0.25D);
				int var11 = -1;
	...
	public Chunk provideChunk(int var1, int var2) {
		...
		this.field_28075_v = this.field_28081_p.getWorldChunkManager().loadBlockGeneratorData(this.field_28075_v, var1 * 16,
				var2 * 16, 16, 16);
	...
	private double[] func_28073_a(double[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		...
		this.field_28089_h = this.field_28095_b.func_4109_a(this.field_28089_h, var2, var4, var5, var7, 200.0D, 200.0D,
				0.5D);
		var8 *= 2.0D;
		this.field_28093_d = this.field_28084_m.generateNoiseOctaves(this.field_28093_d, (double) var2, (double) var3,
				(double) var4, var5, var6, var7, var8 / 80.0D, var10 / 160.0D, var8 / 80.0D);
		this.field_28092_e = this.field_28086_k.generateNoiseOctaves(this.field_28092_e, (double) var2, (double) var3,
				(double) var4, var5, var6, var7, var8, var10, var8);
		this.field_28091_f = this.field_28085_l.generateNoiseOctaves(this.field_28091_f, (double) var2, (double) var3,
				(double) var4, var5, var6, var7, var8, var10, var8);
		int var14 = 0;
		int var15 = 0;
		int var16 = 16 / var5;
	...
	public void populate(IChunkProvider var1, int var2, int var3) {
		...
		if (this.field_28087_j.nextInt(4) == 0) {
			...
			(new WorldGenLakes(Block.waterStill.blockID)).generate(this.field_28081_p, this.field_28087_j, var13, var14,
					var15);
		}
		...
		if (this.field_28087_j.nextInt(8) == 0) {
			...
			if (var14 < 64 || this.field_28087_j.nextInt(10) == 0) {
				(new WorldGenLakes(Block.lavaStill.blockID)).generate(this.field_28081_p, this.field_28087_j, var13, var14,
						var15);
			}
		}
		...
		for (var13 = 0; var13 < 20; ++var13) {
			...
			var15 = this.field_28087_j.nextInt(128);
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new WorldGenMinable(Block.dirt.blockID, 32)).generate(this.field_28081_p, this.field_28087_j, var14, var15,
					var16);
		}
		...
		for (var13 = 0; var13 < 10; ++var13) {
			...
			var15 = this.field_28087_j.nextInt(128);
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new WorldGenMinable(Block.gravel.blockID, 32)).generate(this.field_28081_p, this.field_28087_j, var14, var15,
					var16);
		}
		...
		for (var13 = 0; var13 < 20; ++var13) {
			...
			var15 = this.field_28087_j.nextInt(128);
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new WorldGenMinable(Block.oreCoal.blockID, 16)).generate(this.field_28081_p, this.field_28087_j, var14, var15,
					var16);
		}
		...
		for (var13 = 0; var13 < 20; ++var13) {
			...
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new WorldGenMinable(Block.oreIron.blockID, 8)).generate(this.field_28081_p, this.field_28087_j, var14, var15,
					var16);
		}
		...
		for (var13 = 0; var13 < 2; ++var13) {
			...
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new WorldGenMinable(Block.oreGold.blockID, 8)).generate(this.field_28081_p, this.field_28087_j, var14, var15,
					var16);
		}
		...
		for (var13 = 0; var13 < 8; ++var13) {
			...
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new WorldGenMinable(Block.oreRedstone.blockID, 7)).generate(this.field_28081_p, this.field_28087_j, var14, var15,
					var16);
		}
		...
		for (var13 = 0; var13 < 1; ++var13) {
			...
			var15 = this.field_28087_j.nextInt(16);
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new WorldGenMinable(Block.oreDiamond.blockID, 7)).generate(this.field_28081_p, this.field_28087_j, var14, var15,
					var16);
		}
		...
		for (var13 = 0; var13 < 1; ++var13) {
			...
			var16 = var5 + this.field_28087_j.nextInt(16);
			(new WorldGenMinable(Block.oreLapis.blockID, 6)).generate(this.field_28081_p, this.field_28087_j, var14, var15,
					var16);
		}

		var11 = 0.5D;
		var13 = (int) ((this.field_28094_c.func_806_a((double) var4 * var11, (double) var5 * var11) / 8.0D
				+ this.field_28087_j.nextDouble() * 4.0D + 4.0D) / 3.0D);
		var14 = 0;
		...
		for (var15 = 0; var15 < var14; ++var15) {
			...
			var18.generate(this.field_28081_p, this.field_28087_j, var16, this.field_28081_p.getHeightValue(var16, var17),
					var17);
		}
		...
		for (var15 = 0; var15 < 2; ++var15) {
			...
			(new WorldGenFlowers(Block.plantYellow.blockID)).generate(this.field_28081_p, this.field_28087_j, var16, var17,
					var23);
		}
		...
		if (this.field_28087_j.nextInt(2) == 0) {
			...
			var17 = var5 + this.field_28087_j.nextInt(16) + 8;
			(new WorldGenFlowers(Block.plantRed.blockID)).generate(this.field_28081_p, this.field_28087_j, var15, var16,
					var17);
		}
		...
		if (this.field_28087_j.nextInt(4) == 0) {
			...
			var16 = this.field_28087_j.nextInt(128);
			var17 = var5 + this.field_28087_j.nextInt(16) + 8;
			(new WorldGenFlowers(Block.mushroomBrown.blockID)).generate(this.field_28081_p, this.field_28087_j, var15, var16,
					var17);
		}
		...
		if (this.field_28087_j.nextInt(8) == 0) {
			...
			var16 = this.field_28087_j.nextInt(128);
			var17 = var5 + this.field_28087_j.nextInt(16) + 8;
			(new WorldGenFlowers(Block.mushroomRed.blockID)).generate(this.field_28081_p, this.field_28087_j, var15, var16,
					var17);
		}
		...
		for (var16 = 0; var16 < 50; ++var16) {
			...
			var19 = var5 + this.field_28087_j.nextInt(16) + 8;
			(new WorldGenLiquids(Block.waterMoving.blockID)).generate(this.field_28081_p, this.field_28087_j, var17, var23,
					var19);
		}
		...
		for (var16 = 0; var16 < 20; ++var16) {
			...
			var19 = var5 + this.field_28087_j.nextInt(16) + 8;
			(new WorldGenLiquids(Block.lavaMoving.blockID)).generate(this.field_28081_p, this.field_28087_j, var17, var23,
					var19);
		}

		this.field_28074_w = this.field_28081_p.getWorldChunkManager().getTemperatures(this.field_28074_w, var4 + 8,
				var5 + 8, 16, 16);
		...
		for (var16 = var4 + 8; var16 < var4 + 8 + 16; ++var16) {
			for (var17 = var5 + 8; var17 < var5 + 8 + 16; ++var17) {
				...
				if (var21 < 0.5D && var20 > 0 && var20 < 128 && this.field_28081_p.isAirBlock(var16, var20, var17)
						&& this.field_28081_p.getBlockMaterial(var16, var20 - 1, var17).getIsSolid()
						&& this.field_28081_p.getBlockMaterial(var16, var20 - 1, var17) != Material.ice) {
