...
public class TileEntityRenderer {
	...
	public void cacheActiveRenderInfo(World var1, RenderEngine var2, FontRenderer var3, EntityLiving var4, float var5) {
		...
		this.playerYaw = var4.rotationPitch + (var4.aR - var4.rotationPitch) * var5;
		this.playerPitch = var4.prevRotationYaw + (var4.rotationYaw - var4.prevRotationYaw) * var5;
		this.playerX = var4.bk + (var4.prevPosZ - var4.bk) * (double)var5;
		this.playerY = var4.lastTickPosX + (var4.posX - var4.lastTickPosX) * (double)var5;
		this.playerZ = var4.lastTickPosY + (var4.posY - var4.lastTickPosY) * (double)var5;
	}
