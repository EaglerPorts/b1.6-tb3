...
public class RenderMinecart extends Render {
	...
	public void func_152_a(EntityMinecart var1, double var2, double var4, double var6, float var8, float var9) {
		GL11.glPushMatrix();
		double var10 = var1.bk + (var1.prevPosZ - var1.bk) * (double)var9;
		double var12 = var1.lastTickPosX + (var1.posX - var1.lastTickPosX) * (double)var9;
		...
		float var19 = var1.prevRotationYaw + (var1.rotationYaw - var1.prevRotationYaw) * var9;
		if(var18 != null) {
