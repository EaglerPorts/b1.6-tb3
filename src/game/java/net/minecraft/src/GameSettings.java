...
public class GameSettings {
	...
	public GameSettings(Minecraft var1, VFile2 var2) {
		this.mc = var1;
		this.M = new VFile2(var2, "options.txt");
		this.loadOptions();
	}
	...
	public void loadOptions() {
		try {
			...
			BufferedReader var1 = new BufferedReader(new InputStreamReader(this.M.getInputStream()));
			String var2 = "";
	...
	public void saveOptions() {
		try {
			PrintWriter var1 = new PrintWriter(new OutputStreamWriter(this.M.getOutputStream()));
