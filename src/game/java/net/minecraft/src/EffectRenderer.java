...
public class EffectRenderer {
	...
	public void renderParticles(Entity var1, float var2) {
		float var3 = MathHelper.cos(var1.aR * (float) Math.PI / 180.0F);
		float var4 = MathHelper.sin(var1.aR * (float) Math.PI / 180.0F);
		float var5 = -var4 * MathHelper.sin(var1.rotationYaw * (float) Math.PI / 180.0F);
		float var6 = var3 * MathHelper.sin(var1.rotationYaw * (float) Math.PI / 180.0F);
		float var7 = MathHelper.cos(var1.rotationYaw * (float) Math.PI / 180.0F);
		EntityFX.interpPosX = var1.bk + (var1.prevPosZ - var1.bk) * (double) var2;
		EntityFX.interpPosY = var1.lastTickPosX + (var1.posX - var1.lastTickPosX) * (double) var2;
		EntityFX.interpPosZ = var1.lastTickPosY + (var1.posY - var1.lastTickPosY) * (double) var2;
			...
			for (int var8 = 0; var8 < var7; ++var8) {
				for (int var9 = 0; var9 < var7; ++var9) {
					for (int var10 = 0; var10 < var7; ++var10) {
						...
						this.addEffect((new EntityDiggingFX(this.worldObj, var11, var13, var15, var11 - (double) var1 - 0.5D,
								var13 - (double) var2 - 0.5D, var15 - (double) var3 - 0.5D, var6)).func_4041_a(var1, var2, var3));
					}
				}
			}
