...
public class EntityRenderer {
	...
	public void updateRenderer() {
		...
		float var1 = this.mc.theWorld.getLightBrightness(MathHelper.floor_double(this.mc.renderViewEntity.prevPosZ), MathHelper.floor_double(this.mc.renderViewEntity.posX), MathHelper.floor_double(this.mc.renderViewEntity.posY));
	...
	public void getMouseOver(float var1) {
		if(this.mc.renderViewEntity != null) {
			if(this.mc.theWorld != null) {
				...
				float var9 = 1.0F;
				List var10 = this.mc.theWorld.getEntitiesWithinAABBExcludingEntity(this.mc.renderViewEntity, this.mc.renderViewEntity.aV.addCoord(var7.xCoord * var2, var7.yCoord * var2, var7.zCoord * var2).expand((double)var9, (double)var9, (double)var9));
				double var11 = 0.0D;
	...
	private void updateFogColor(float var1) {
		...
		if(var2.isPlayerSleeping()) {
			...
			if(!this.mc.gameSettings.field_22273_E) {
				int var10 = this.mc.theWorld.getBlockId(MathHelper.floor_double(var2.prevPosZ), MathHelper.floor_double(var2.posX), MathHelper.floor_double(var2.posY));
				if(var10 == Block.blockBed.blockID) {
					int var11 = this.mc.theWorld.getBlockMetadata(MathHelper.floor_double(var2.prevPosZ), MathHelper.floor_double(var2.posX), MathHelper.floor_double(var2.posY));
					int var12 = var11 & 3;
	...
	private void setupCameraTransform(float var1, int var2) {
		...
		if(this.cameraZoom != 1.0D) {
			...
			GLU.gluPerspective(this.e(var1), (float)this.mc.displayWidth / (float)this.mc.displayHeight, 0.05F, this.farPlaneDistance * 2.0F);
		} else {
			GLU.gluPerspective(this.e(var1), (float)this.mc.displayWidth / (float)this.mc.displayHeight, 0.05F, this.farPlaneDistance * 2.0F);
		}
	...
	private void addRainParticles() {
		...
		if(var1 != 0.0F) {
			...
			if(var14 > 0 && this.I.nextInt(3) < this.J++) {
				this.J = 0;
				if(var10 > var2.posX + 1.0D && var3.findTopSolidBlock(MathHelper.floor_double(var2.prevPosZ), MathHelper.floor_double(var2.posY)) > MathHelper.floor_double(var2.posX)) {
			...
			for(var19 = var5 - var16; var19 <= var5 + var16; ++var19) {
				for(var20 = var7 - var16; var20 <= var7 + var16; ++var20) {
					...
					if(var21.canSpawnLightningBolt()) {
						...
						if(var23 != var24) {
							this.I.setSeed((long)(var19 * var19 * 3121 + var19 * 45238971 + var20 * var20 * 418711 + var20 * 13761));
							var26 = ((float)(this.rendererUpdateCount + var19 * var19 * 3121 + var19 * 45238971 + var20 * var20 * 418711 + var20 * 13761 & 31) + var1) / 32.0F * (3.0F + this.I.nextFloat());
