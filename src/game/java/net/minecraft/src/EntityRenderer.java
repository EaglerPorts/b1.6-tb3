...
public class EntityRenderer {
	...
	public void updateRenderer() {
		...
		float var1 = this.mc.theWorld.getLightBrightness(MathHelper.floor_double(this.mc.renderViewEntity.prevPosZ),
				MathHelper.floor_double(this.mc.renderViewEntity.posX), MathHelper.floor_double(this.mc.renderViewEntity.posY));
		float var2 = (float) (3 - this.mc.gameSettings.renderDistance) / 3.0F;
		float var3 = var1 * (1.0F - var2) + var2;
		this.fogColor2 += (var3 - this.fogColor2) * 0.1F;
		...
		if (this.mc.renderViewEntity != null) {
			if (this.mc.theWorld != null) {
				...
				List var10 = this.mc.theWorld.getEntitiesWithinAABBExcludingEntity(this.mc.renderViewEntity,
						this.mc.renderViewEntity.aV.addCoord(var7.xCoord * var2, var7.yCoord * var2, var7.zCoord * var2)
				...
				for (int var13 = 0; var13 < var10.size(); ++var13) {
					...
					if (var14.canBeCollidedWith()) {
						...
						AxisAlignedBB var16 = var14.aV.expand((double) var15, (double) var15, (double) var15);
	...
	private void setupViewBobbing(float var1) {
		EntityLiving var2 = this.mc.renderViewEntity;
		float var3 = (float) var2.prevHealth - var1;
		float var4;
		if (var2.X <= 0) {
			var4 = (float) var2.ac + var1;
			GL11.glRotatef(40.0F - 8000.0F / (var4 + 200.0F), 0.0F, 0.0F, 1.0F);
		}

		if (var3 >= 0.0F) {
			var3 /= (float) var2.hurtTime;
	...
	private void orientCamera(float var1) {
		if (this.mc.renderViewEntity instanceof EntityPlayer) {
			...
			float var6 = var2.ae + (var2.cameraPitch - var2.ae) * var1;
	...
	private void updateFogColor(float var1) {
		EntityLiving var2 = this.mc.renderViewEntity;
		float var3 = var2.be - 1.62F;
		double var4 = var2.aI + (var2.prevPosZ - var2.aI) * (double) var1;
		double var6 = var2.prevPosX + (var2.posX - var2.prevPosX) * (double) var1 - (double) var3;
		double var8 = var2.prevPosY + (var2.posY - var2.prevPosY) * (double) var1;
		...
		if (var2.isPlayerSleeping()) {
			...
			if (!this.mc.gameSettings.field_22273_E) {
				int var10 = this.mc.theWorld.getBlockId(MathHelper.floor_double(var2.prevPosZ),
						MathHelper.floor_double(var2.posX), MathHelper.floor_double(var2.posY));
				if (var10 == Block.blockBed.blockID) {
					int var11 = this.mc.theWorld.getBlockMetadata(MathHelper.floor_double(var2.prevPosZ),
							MathHelper.floor_double(var2.posX), MathHelper.floor_double(var2.posY));
					int var12 = var11 & 3;
					GL11.glRotatef((float) (var12 * 90), 0.0F, 1.0F, 0.0F);
				}

				GL11.glRotatef(var2.rotationPitch + (var2.aR - var2.rotationPitch) * var1 + 180.0F, 0.0F, -1.0F, 0.0F);
				GL11.glRotatef(var2.prevRotationYaw + (var2.rotationYaw - var2.prevRotationYaw) * var1, -1.0F, 0.0F, 0.0F);
			}
			...
			if (this.mc.gameSettings.field_22273_E) {
				...
				GL11.glRotatef(var2.rotationYaw - var13, 1.0F, 0.0F, 0.0F);
				GL11.glRotatef(var2.aR - var28, 0.0F, 1.0F, 0.0F);
				GL11.glTranslatef(0.0F, 0.0F, (float) (-var27));
				GL11.glRotatef(var28 - var2.aR, 0.0F, 1.0F, 0.0F);
				GL11.glRotatef(var13 - var2.rotationYaw, 1.0F, 0.0F, 0.0F);
			}
		} else {
		...
		var4 = var2.aI + (var2.prevPosZ - var2.aI) * (double) var1;
		var6 = var2.prevPosX + (var2.posX - var2.prevPosX) * (double) var1 - (double) var3;
		var8 = var2.prevPosY + (var2.posY - var2.prevPosY) * (double) var1;
	...
	private void setupCameraTransform(float var1, int var2) {
		...
		if (this.cameraZoom != 1.0D) {
			...
			GLU.gluPerspective(this.e(var1), (float) this.mc.displayWidth / (float) this.mc.displayHeight, 0.05F,
		...
		float var4 = this.mc.thePlayer.timeInPortal + (this.mc.thePlayer.A - this.mc.thePlayer.timeInPortal) * var1;
		if (var4 > 0.0F) {
	...
	public void renderRainSnow(float var1) {
		...
		double var5 = var2.bk + (var2.prevPosZ - var2.bk) * (double) var1;
		double var7 = var2.lastTickPosX + (var2.posX - var2.lastTickPosX) * (double) var1;
		double var9 = var2.lastTickPosY + (var2.posY - var2.lastTickPosY) * (double) var1;
		...
		for (int var15 = 0; var15 < 2; ++var15) {
			...
			if (this.mc.objectMouseOver != null && var2.isInsideOfMaterial(Material.water) && var2 instanceof EntityPlayer) {
				...
				var3.drawBlockBreaking(var17, this.mc.objectMouseOver, 0, var17.inventory.getCurrentItem(), var1);
			...
			if (this.cameraZoom == 1.0D && var2 instanceof EntityPlayer && this.mc.objectMouseOver != null
	...
	private void addRainParticles() {
		...
		if (var1 != 0.0F) {
			this.I.setSeed((long) this.rendererUpdateCount * 312987231L);
			EntityLiving var2 = this.mc.renderViewEntity;
			World var3 = this.mc.theWorld;
			int var4 = MathHelper.floor_double(var2.prevPosZ);
			int var5 = MathHelper.floor_double(var2.posX);
			int var6 = MathHelper.floor_double(var2.posY);
			byte var7 = 10;
			double var8 = 0.0D;
			double var10 = 0.0D;
			double var12 = 0.0D;
			...
			for (int var15 = 0; var15 < (int) (100.0F * var1 * var1); ++var15) {
				int var16 = var4 + this.I.nextInt(var7) - this.I.nextInt(var7);
				int var17 = var6 + this.I.nextInt(var7) - this.I.nextInt(var7);
				...
				if (var18 <= var5 + var7 && var18 >= var5 - var7
						&& var3.getWorldChunkManager().getBiomeGenAt(var16, var17).canSpawnLightningBolt()) {
					float var20 = this.I.nextFloat();
					float var21 = this.I.nextFloat();
					if (var19 > 0) {
						if (Block.blocksList[var19].blockMaterial == Material.lava) {
							this.mc.effectRenderer.addEffect(new EntitySmokeFX(var3, (double) ((float) var16 + var20),
									(double) ((float) var18 + 0.1F) - Block.blocksList[var19].minY, (double) ((float) var17 + var21),
									0.0D, 0.0D, 0.0D));
						} else {
							++var14;
							if (this.I.nextInt(var14) == 0) {
								var8 = (double) ((float) var16 + var20);
								var10 = (double) ((float) var18 + 0.1F) - Block.blocksList[var19].minY;
								var12 = (double) ((float) var17 + var21);
							}

							this.mc.effectRenderer.addEffect(new EntityRainFX(var3, (double) ((float) var16 + var20),
									(double) ((float) var18 + 0.1F) - Block.blocksList[var19].minY, (double) ((float) var17 + var21)));
						}
					}
				}
			...
			if (var14 > 0 && this.I.nextInt(3) < this.J++) {
				this.J = 0;
				if (var10 > var2.posX + 1.0D && var3.findTopSolidBlock(MathHelper.floor_double(var2.prevPosZ),
						MathHelper.floor_double(var2.posY)) > MathHelper.floor_double(var2.posX)) {
	...
	protected void d(float var1) {
		...
		if (var2 > 0.0F) {
			...
			int var5 = MathHelper.floor_double(var3.prevPosZ);
			int var6 = MathHelper.floor_double(var3.posX);
			int var7 = MathHelper.floor_double(var3.posY);
			...
			double var9 = var3.bk + (var3.prevPosZ - var3.bk) * (double) var1;
			double var11 = var3.lastTickPosX + (var3.posX - var3.lastTickPosX) * (double) var1;
			double var13 = var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double) var1;
			...
			BiomeGenBase[] var17 = var4.getWorldChunkManager().func_4069_a(var5 - var16, var7 - var16, var16 * 2 + 1,
					var16 * 2 + 1);
			int var18 = 0;
			...
			for (var19 = var5 - var16; var19 <= var5 + var16; ++var19) {
				for (var20 = var7 - var16; var20 <= var7 + var16; ++var20) {
					...
					if (var21.getEnableSnow()) {
						...
						var26 = 1.0F;
						if (var24 != var25) {
							this.I.setSeed((long) (var19 * var19 * 3121 + var19 * 45238971 + var20 * var20 * 418711 + var20 * 13761));
							float var27 = (float) this.rendererUpdateCount + var1;
							float var28 = ((float) (this.rendererUpdateCount & 511) + var1) / 512.0F;
							float var29 = this.I.nextFloat() + var27 * 0.01F * (float) this.I.nextGaussian();
							float var30 = this.I.nextFloat() + var27 * (float) this.I.nextGaussian() * 0.001F;
							double var31 = (double) ((float) var19 + 0.5F) - var3.prevPosZ;
							double var33 = (double) ((float) var20 + 0.5F) - var3.posY;
							...
							var8.addVertexWithUV((double) (var19 + 0), (double) var24, (double) var20 + 0.5D,
									(double) (0.0F * var26 + var29), (double) ((float) var24 * var26 / 4.0F + var28 * var26 + var30));
							var8.addVertexWithUV((double) (var19 + 1), (double) var24, (double) var20 + 0.5D,
									(double) (1.0F * var26 + var29), (double) ((float) var24 * var26 / 4.0F + var28 * var26 + var30));
							var8.addVertexWithUV((double) (var19 + 1), (double) var25, (double) var20 + 0.5D,
									(double) (1.0F * var26 + var29), (double) ((float) var25 * var26 / 4.0F + var28 * var26 + var30));
							var8.addVertexWithUV((double) (var19 + 0), (double) var25, (double) var20 + 0.5D,
									(double) (0.0F * var26 + var29), (double) ((float) var25 * var26 / 4.0F + var28 * var26 + var30));
							var8.addVertexWithUV((double) var19 + 0.5D, (double) var24, (double) (var20 + 0),
									(double) (0.0F * var26 + var29), (double) ((float) var24 * var26 / 4.0F + var28 * var26 + var30));
							var8.addVertexWithUV((double) var19 + 0.5D, (double) var24, (double) (var20 + 1),
									(double) (1.0F * var26 + var29), (double) ((float) var24 * var26 / 4.0F + var28 * var26 + var30));
							var8.addVertexWithUV((double) var19 + 0.5D, (double) var25, (double) (var20 + 1),
									(double) (1.0F * var26 + var29), (double) ((float) var25 * var26 / 4.0F + var28 * var26 + var30));
							var8.addVertexWithUV((double) var19 + 0.5D, (double) var25, (double) (var20 + 0),
									(double) (0.0F * var26 + var29), (double) ((float) var25 * var26 / 4.0F + var28 * var26 + var30));
			...
			for (var19 = var5 - var16; var19 <= var5 + var16; ++var19) {
				for (var20 = var7 - var16; var20 <= var7 + var16; ++var20) {
					...
					if (var21.canSpawnLightningBolt()) {
						...
						if (var23 != var24) {
							this.I.setSeed((long) (var19 * var19 * 3121 + var19 * 45238971 + var20 * var20 * 418711 + var20 * 13761));
							var26 = ((float) (this.rendererUpdateCount + var19 * var19 * 3121 + var19 * 45238971
									+ var20 * var20 * 418711 + var20 * 13761 & 31) + var1) / 32.0F * (3.0F + this.I.nextFloat());
							double var38 = (double) ((float) var19 + 0.5F) - var3.prevPosZ;
							double var39 = (double) ((float) var20 + 0.5F) - var3.posY;
							...
							var8.setTranslationD(-var9 * 1.0D, -var11 * 1.0D, -var13 * 1.0D);
							var8.addVertexWithUV((double) (var19 + 0), (double) var23, (double) var20 + 0.5D, (double) (0.0F * var37),
									(double) ((float) var23 * var37 / 4.0F + var26 * var37));
							var8.addVertexWithUV((double) (var19 + 1), (double) var23, (double) var20 + 0.5D, (double) (1.0F * var37),
									(double) ((float) var23 * var37 / 4.0F + var26 * var37));
							var8.addVertexWithUV((double) (var19 + 1), (double) var24, (double) var20 + 0.5D, (double) (1.0F * var37),
									(double) ((float) var24 * var37 / 4.0F + var26 * var37));
							var8.addVertexWithUV((double) (var19 + 0), (double) var24, (double) var20 + 0.5D, (double) (0.0F * var37),
									(double) ((float) var24 * var37 / 4.0F + var26 * var37));
							var8.addVertexWithUV((double) var19 + 0.5D, (double) var23, (double) (var20 + 0), (double) (0.0F * var37),
									(double) ((float) var23 * var37 / 4.0F + var26 * var37));
							var8.addVertexWithUV((double) var19 + 0.5D, (double) var23, (double) (var20 + 1), (double) (1.0F * var37),
									(double) ((float) var23 * var37 / 4.0F + var26 * var37));
							var8.addVertexWithUV((double) var19 + 0.5D, (double) var24, (double) (var20 + 1), (double) (1.0F * var37),
									(double) ((float) var24 * var37 / 4.0F + var26 * var37));
							var8.addVertexWithUV((double) var19 + 0.5D, (double) var24, (double) (var20 + 0), (double) (0.0F * var37),
									(double) ((float) var24 * var37 / 4.0F + var26 * var37));
							var8.setTranslationD(0.0D, 0.0D, 0.0D);
							var8.draw();
						}
	...
	private void i(float var1) {
		...
		var12 = this.K + (this.fogColor2 - this.K) * var1;
		this.fogColorRed *= var12;
		this.fogColorGreen *= var12;
		this.fogColorBlue *= var12;
		if (this.mc.gameSettings.anaglyph) {
