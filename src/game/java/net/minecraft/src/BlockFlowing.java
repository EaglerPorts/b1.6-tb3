...
public class BlockFlowing extends BlockFluid {
		...
		for (int var8 = 0; var8 < 4; ++var8) {
			if ((var8 != 0 || var6 != 1) && (var8 != 1 || var6 != 0) && (var8 != 2 || var6 != 3)
				...
				if (!this.blockBlocksFlow(var1, var9, var3, var11)
						&& (var1.getBlockMaterial(var9, var3, var11) != this.blockMaterial
	...
	private boolean[] getOptimalFlowDirections(World var1, int var2, int var3, int var4) {
		...
		for (var5 = 0; var5 < 4; ++var5) {
			...
			if (!this.blockBlocksFlow(var1, var6, var3, var8)
					&& (var1.getBlockMaterial(var6, var3, var8) != this.blockMaterial
	...
	private boolean liquidCanDisplaceBlock(World var1, int var2, int var3, int var4) {
		...
		return var5 == this.blockMaterial ? false
				: (var5 == Material.lava ? false : !this.blockBlocksFlow(var1, var2, var3, var4));
	}
