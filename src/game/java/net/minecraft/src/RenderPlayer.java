...
public class RenderPlayer extends RenderLiving {
	...
	public void func_188_a(EntityPlayer var1, double var2, double var4, double var6, float var8, float var9) {
		...
		double var11 = var4 - (double)var1.be;
		if(var1.isSneaking()) {
			var11 -= 0.125D;
		}
	...
	protected void renderSpecials(EntityPlayer var1, float var2) {
		...
		float var5;
		if(var1.username.equals("deadmau5") && this.loadDownloadableImageTexture(var1.bz, (String)null)) {
			for(int var19 = 0; var19 < 2; ++var19) {
				var5 = var1.rotationPitch + (var1.aR - var1.rotationPitch) * var2 - (var1.renderYawOffset + (var1.field_9363_r - var1.renderYawOffset) * var2);
		...
		/* B1.6_TB3 TODO: if(this.loadDownloadableImageTexture(var1.playerCloakUrl, (String)null)) {
			GL11.glPushMatrix();
			GL11.glTranslatef(0.0F, 0.0F, 2.0F / 16.0F);
			double var20 = var1.field_20066_r + (var1.field_20063_u - var1.field_20066_r) * (double)var2 - (var1.aI + (var1.prevPosZ - var1.aI) * (double)var2);
			double var22 = var1.field_20065_s + (var1.field_20062_v - var1.field_20065_s) * (double)var2 - (var1.prevPosX + (var1.posX - var1.prevPosX) * (double)var2);
			double var8 = var1.field_20064_t + (var1.field_20061_w - var1.field_20064_t) * (double)var2 - (var1.prevPosY + (var1.posY - var1.prevPosY) * (double)var2);
			float var10 = var1.renderYawOffset + (var1.field_9363_r - var1.renderYawOffset) * var2;
			...
			var15 += MathHelper.sin((var1.height + (var1.prevDistanceWalkedModified - var1.height) * var2) * 6.0F) * 32.0F * var18;
			if(var1.isSneaking()) {
				var15 += 25.0F;
			}
	...
	protected void func_22016_b(EntityPlayer var1, double var2, double var4, double var6) {
		if(var1.isEntityAlive() && var1.isPlayerSleeping()) {
			super.func_22012_b(var1, var2 + (double)var1.v, var4 + (double)var1.field_22063_x, var6 + (double)var1.field_22062_y);
		} else {
