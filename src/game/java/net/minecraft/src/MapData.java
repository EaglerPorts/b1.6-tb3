...
public class MapData extends MapDataBase {
	...
	public void func_28169_a(EntityPlayer var1, ItemStack var2) {
		...
		for(int var14 = 0; var14 < this.field_28174_h.size(); ++var14) {
			...
			if(!var4.field_28120_a.field_9293_aM && var4.field_28120_a.inventory.func_28018_c(var2)) {
				float var5 = (float)(var4.field_28120_a.prevPosZ - (double)this.field_28180_b) / (float)(1 << this.field_28177_e);
				float var6 = (float)(var4.field_28120_a.posY - (double)this.field_28179_c) / (float)(1 << this.field_28177_e);
				byte var7 = 64;
				byte var8 = 64;
				if(var5 >= (float)(-var7) && var6 >= (float)(-var8) && var5 <= (float)var7 && var6 <= (float)var8) {
					...
					byte var12 = (byte)((int)((double)(var1.aR * 16.0F / 360.0F) + 0.5D));
