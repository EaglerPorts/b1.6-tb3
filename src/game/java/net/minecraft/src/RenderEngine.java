	...
	public int[] func_28149_a(String var1) {
		...
		if(var3 != null) {
			...
			try {
				Object var6 = null;
				if(var1.startsWith("##")) {
					var3 = this.func_28148_b(this.unwrapImageByColumns(this.readTextureImage(TexturePack.getResourceAsStream(var1.substring(2)))));
				} else if(var1.startsWith("%clamp%")) {
					this.clampTexture = true;
					var3 = this.func_28148_b(this.readTextureImage(TexturePack.getResourceAsStream(var1.substring(7))));
					this.clampTexture = false;
				} else if(var1.startsWith("%blur%")) {
					this.blurTexture = true;
					var3 = this.func_28148_b(this.readTextureImage(TexturePack.getResourceAsStream(var1.substring(6))));
