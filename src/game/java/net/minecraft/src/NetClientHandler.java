...
public class NetClientHandler extends NetHandler {
	...
	public void handleLogin(Packet1Login var1) {
		...
		this.mc.thePlayer.aC = var1.protocolVersion;
	}
	...
	public void handlePickupSpawn(Packet21PickupSpawn var1) {
		...
		var8.posZ = (double) var1.rotation / 128.0D;
		var8.motionX = (double) var1.pitch / 128.0D;
		var8.motionY = (double) var1.roll / 128.0D;
		var8.chunkCoordZ = var1.xPosition;
		var8.serverPosX = var1.yPosition;
		var8.serverPosY = var1.zPosition;
	...
	public void handleVehicleSpawn(Packet23VehicleSpawn var1) {
		...
		if (var8 != null) {
			((Entity) var8).chunkCoordZ = var1.xPosition;
			((Entity) var8).serverPosX = var1.yPosition;
			((Entity) var8).serverPosY = var1.zPosition;
			((Entity) var8).aR = 0.0F;
			((Entity) var8).rotationYaw = 0.0F;
			((Entity) var8).aC = var1.entityId;
	...
	public void handleWeather(Packet71Weather var1) {
		...
		if (var8 != null) {
			var8.chunkCoordZ = var1.field_27053_b;
			var8.serverPosX = var1.field_27057_c;
			var8.serverPosY = var1.field_27056_d;
			var8.aR = 0.0F;
			var8.rotationYaw = 0.0F;
			var8.aC = var1.field_27054_a;
	...
	public void handleNamedEntitySpawn(Packet20NamedEntitySpawn var1) {
		...
		var10.aI = var10.bk = (double) (var10.chunkCoordZ = var1.xPosition);
		var10.prevPosX = var10.lastTickPosX = (double) (var10.serverPosX = var1.yPosition);
		var10.prevPosY = var10.lastTickPosY = (double) (var10.serverPosY = var1.zPosition);
	...
	public void handleEntityTeleport(Packet34EntityTeleport var1) {
		Entity var2 = this.getEntityByID(var1.entityId);
		if (var2 != null) {
			var2.chunkCoordZ = var1.xPosition;
			var2.serverPosX = var1.yPosition;
			var2.serverPosY = var1.zPosition;
			double var3 = (double) var2.chunkCoordZ / 32.0D;
			double var5 = (double) var2.serverPosX / 32.0D + 1.0D / 64.0D;
			double var7 = (double) var2.serverPosY / 32.0D;
	...
	public void handleEntity(Packet30Entity var1) {
		...
		if (var2 != null) {
			...
			double var5 = (double) var2.serverPosX / 32.0D + 1.0D / 64.0D;
			double var7 = (double) var2.serverPosY / 32.0D;
			float var9 = var1.rotating ? (float) (var1.yaw * 360) / 256.0F : var2.aR;
			float var10 = var1.rotating ? (float) (var1.pitch * 360) / 256.0F : var2.rotationYaw;
			var2.setPositionAndRotation2(var3, var5, var7, var9, var10, 3);
		}
	}
	...
	public void handleFlying(Packet10Flying var1) {
		...
		double var3 = var2.prevPosZ;
		double var5 = var2.posX;
		double var7 = var2.posY;
		float var9 = var2.aR;
		float var10 = var2.rotationYaw;
		if (var1.moving) {
			var3 = var1.xPosition;
			var5 = var1.yPosition;
			var7 = var1.zPosition;
		...
		var2.bn = 0.0F;
		var2.posZ = var2.motionX = var2.motionY = 0.0D;
		var2.setPositionAndRotation(var3, var5, var7, var9, var10);
		var1.xPosition = var2.prevPosZ;
		var1.yPosition = var2.aV.minY;
		var1.zPosition = var2.posY;
		var1.stance = var2.posX;
		this.netManager.addToSendQueue(var1);
		if (!this.field_1210_g) {
			this.mc.thePlayer.aI = this.mc.thePlayer.prevPosZ;
	...
	public void handleMapChunk(Packet51MapChunk var1) {
		this.worldClient.func_711_c(var1.xPosition, var1.yPosition, var1.zPosition, var1.xPosition + var1.xSize - 1,
				var1.yPosition + var1.ySize - 1, var1.zPosition + var1.zSize - 1);
	...
	public void handleKickDisconnect(Packet255KickDisconnect var1) {
		...
		this.mc.displayGuiScreen(
				new GuiConnectFailed("disconnect.disconnected", "disconnect.genericReason", new Object[] { var1.reason }));
	}
	...
	public void handleHandshake(Packet2Handshake var1) {
		if (var1.username.equals("-")) {
			this.addToSendQueue(new Packet1Login(this.mc.session.username, 12));
		} else {
			try {
				URL var2 = new URL("http://www.minecraft.net/game/joinserver.jsp?user=" + this.mc.session.username
						+ "&sessionId=" + this.mc.session.sessionId + "&serverId=" + var1.username);
				...
				this.netManager.networkShutdown("disconnect.genericReason",
						new Object[] { "Internal client error: " + var5.toString() });
			}
		}
	...
	public void handleMobSpawn(Packet24MobSpawn var1) {
		...
		var10.chunkCoordZ = var1.xPosition;
		var10.serverPosX = var1.yPosition;
		var10.serverPosY = var1.zPosition;
		var10.aC = var1.entityId;
		var10.setPositionAndRotation(var2, var4, var6, var8, var9);
		var10.U = true;
		this.worldClient.func_712_a(var1.entityId, var10);
	...
	public void func_6497_a(Packet39AttachEntity var1) {
		...
		if (var1.entityId == this.mc.thePlayer.aC) {
	...
	private Entity getEntityByID(int var1) {
		return (Entity) (var1 == this.mc.thePlayer.aC ? this.mc.thePlayer : this.worldClient.func_709_b(var1));
	}
	...
	public void func_20087_a(Packet100OpenWindow var1) {
		if (var1.inventoryType == 0) {
			...
			this.mc.thePlayer.displayWorkbenchGUI(MathHelper.floor_double(var5.prevPosZ), MathHelper.floor_double(var5.posX),
					MathHelper.floor_double(var5.posY));
			this.mc.thePlayer.craftingInventory.windowId = var1.windowId;
		}
	...
	public void func_28115_a(Packet61DoorChange var1) {
		this.mc.theWorld.func_28106_e(var1.field_28050_a, var1.field_28053_c, var1.field_28052_d, var1.field_28051_e,
				var1.field_28049_b);
	}

	public void func_27245_a(Packet200Statistic var1) {
		((EntityClientPlayerMP) this.mc.thePlayer).func_27027_b(StatList.func_27361_a(var1.field_27052_a),
				var1.field_27051_b);
	}
