...
public class Packet71Weather extends Packet {
	...
	public Packet71Weather(Entity var1) {
		this.field_27054_a = var1.aC;
		this.field_27053_b = MathHelper.floor_double(var1.prevPosZ * 32.0D);
		this.field_27057_c = MathHelper.floor_double(var1.posX * 32.0D);
		this.field_27056_d = MathHelper.floor_double(var1.posY * 32.0D);
