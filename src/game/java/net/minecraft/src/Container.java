		...
		if(var2 == 0 || var2 == 1) {
			...
			if(var1 == -999) {
				...
				if(var7 != null) {
					...
					if(var8 != null && var8.getStack() != null) {
				...
				if(var12 != null) {
					...
					if(var13 == null) {
						...
						if(var13.itemID != var9.itemID || var13.getHasSubtypes() && var13.getItemDamage() != var9.getItemDamage()) {
							...
							if(var10 > var9.getMaxStackSize() - var13.stackSize) {
								var10 = var9.getMaxStackSize() - var13.stackSize;
							}
					...
					} else if(var13.itemID == var9.itemID && var9.getMaxStackSize() > 1 && (!var13.getHasSubtypes() || var13.getItemDamage() == var9.getItemDamage())) {
