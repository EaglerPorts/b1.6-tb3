...
public class ItemRenderer {
	...
	public void renderItemInFirstPerson(float var1) {
		...
		float var4 = var3.prevRotationYaw + (var3.rotationYaw - var3.prevRotationYaw) * var1;
		GL11.glPushMatrix();
		GL11.glRotatef(var4, 1.0F, 0.0F, 0.0F);
		GL11.glRotatef(var3.rotationPitch + (var3.aR - var3.rotationPitch) * var1, 0.0F, 1.0F, 0.0F);
		RenderHelper.enableStandardItemLighting();
		GL11.glPopMatrix();
		float var5 = this.mc.theWorld.getLightBrightness(MathHelper.floor_double(var3.prevPosZ), MathHelper.floor_double(var3.posX), MathHelper.floor_double(var3.posY));
		...
		if(var6 != null && var6.itemID == Item.mapItem.shiftedIndex) {
			...
			GL11.glEnable(GL12.GL_RESCALE_NORMAL);
			GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTextureForDownloadableImage(this.mc.thePlayer.bz, this.mc.thePlayer.getEntityTexture()));
	...
	public void renderOverlays(float var1) {
		...
		if(this.mc.thePlayer.isEntityInsideOpaqueBlock()) {
			var2 = MathHelper.floor_double(this.mc.thePlayer.prevPosZ);
			int var3 = MathHelper.floor_double(this.mc.thePlayer.posX);
			int var4 = MathHelper.floor_double(this.mc.thePlayer.posY);
			...
			if(this.mc.theWorld.func_28100_h(var2, var3, var4)) {
				...
				for(int var7 = 0; var7 < 8; ++var7) {
					float var8 = ((float)((var7 >> 0) % 2) - 0.5F) * this.mc.thePlayer.yOffset * 0.9F;
					float var9 = ((float)((var7 >> 1) % 2) - 0.5F) * this.mc.thePlayer.width * 0.2F;
					float var10 = ((float)((var7 >> 2) % 2) - 0.5F) * this.mc.thePlayer.yOffset * 0.9F;
	...
	private void renderWarpedTextureOverlay(float var1) {
		...
		float var8 = 1.0F;
		float var9 = -0.5F;
		float var10 = -this.mc.thePlayer.aR / 64.0F;
